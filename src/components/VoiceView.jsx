    ...
    <div className="relative" style={{ width: size, height: size }}>
      ...
      {active && (
        <div
          ...
          style={{
            ...
            background: "conic-gradient(from 0deg, #3b82f6, #a855f7, #f97316, #ec4899, #3b82f6)",
      ...
      >
        ...
        <div
          ...
          style={{
            background: "conic-gradient(from 0deg, #3b82f6, #8b5cf6, #f97316, #ec4899, #06b6d4, #3b82f6)",
        ...
        <div
          className="absolute inset-0"
          style={{
            background: "radial-gradient(circle at 35% 35%, rgba(255,255,255,0.25) 0%, transparent 55%)",
            zIndex: 2,
          }}
        />
    ...
    <div className="w-full max-w-3xl mx-auto flex flex-col items-center animate-fade-in">
      <div className="text-center mb-4">
        ...
        <p className="text-xs sm:text-sm text-[#8A7D68] mt-1 max-w-lg mx-auto">
          Speak in English — get a live transcript and translation into Nuer or Dinka
        </p>
      </div>
